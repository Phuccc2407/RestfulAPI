    ...
    public partial class InitIdentityTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ArtistId = table.Column<string>(type: "nvarchar(450)", nullable: false, defaultValueSql: "(newid())"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PerformedBy = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    PlaylistId = table.Column<string>(type: "nvarchar(450)", nullable: false, defaultValueSql: "(newid())"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FolloweeArtistId = table.Column<string>(type: "nvarchar(450)", nullable: true),
                    FolloweeUserId = table.Column<string>(type: "nvarchar(450)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TrackId = table.Column<string>(type: "nvarchar(450)", nullable: false, defaultValueSql: "(newid())"),
